...
const CardsContextProvider = (props) => {
    ...
    //AVISO DE MAIL ENVIADO, EL DIV DESAPARECE CON ANIMACIÓN, PERO IGUALMENTE SE LIMPIA LA PROPIEDAD PARA EVITAR QUE SE SIGA
    //RENDERIZANDO EL COMPONENTE
    const mailHasBeenSent = (postingId) => {
        setSentMails([...sentMails, postingId])
        setTimeout(function () { setSentMails([]); }, 5000);
    }
