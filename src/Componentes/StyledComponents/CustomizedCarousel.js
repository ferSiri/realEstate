...
function CustomizedPicCar(props) {
    ...
    ${props => { return props.isFav ? "background-color: red;" : "background-color: #fff;" }}
    display: flex;
    ...
    return (<StyledContainer>
        <StyledImg className="fade" imagen={props.imagen}>
            <StyledPanel>
                <SubPanel>
                    <PublicationPlan>{props.plan}</PublicationPlan>
                    <StyledHeart onClick={() => props.setFav(props.targetId)} targetId={props.targetId} isFav={props.isFav}><span className="far fa-heart"></span></StyledHeart>
                </SubPanel>
                <SubPanel>
